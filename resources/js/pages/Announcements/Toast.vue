...
const palette: Record<string, string> = {
  success: 'border-green-300 bg-green-50 text-green-800 dark:bg-green-900/30 dark:text-green-200',
  error: 'border-red-300 bg-red-50 text-red-800 dark:bg-red-900/30 dark:text-red-200',
  info: 'border-blue-300 bg-blue-50 text-blue-800 dark:bg-blue-900/30 dark:text-blue-200',
  warning: 'border-yellow-300 bg-yellow-50 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-200',
};
</script>
